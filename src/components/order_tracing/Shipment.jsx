...
function Shipment({shipment, key, index, setcurrentShipment}) {
  ...
  return (
    <div className="bg-gray-300 rounded-lg p-2 px-5 mx-3 border shadow-md text-center cursor-pointer">
      ...
      <button className="bg-[#4F80E1] text-white rounded-md p-2 h-10 mb-4 sm:mb-0" onClick={() => navigate("/quality")}>
        Check Quality
      </button>
    </div>
  );
